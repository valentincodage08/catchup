	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form class="login100-form validate-form" action="../controllers/inscription.php" method="POST">
					<span class="login100-form-title p-b-33">
						Inscription
					</span>

                    <div class="wrap-input100 validate-input" data-validate="Champ requis">
						<input class="input100" type="text" name="firstname" placeholder="Prénom">
					...
					<div class="wrap-input100 rs1 validate-input" data-validate="Champ requis">
